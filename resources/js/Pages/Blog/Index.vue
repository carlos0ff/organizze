        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="hidden md:flex items-center justify-center space-x-8 flex-1">
                    ...
                    <a href="#mais-lidos" class="relative inline-flex items-center text-sm font-semibold text-[#1F2933] group animete-pulse">
                        <span class="relative z-10 px-1">Mais lidos</span>
                        <span class="absolute left-0 bottom-1 w-full h-1.5 bg-[#3D9258] opacity-90 transition-all duration-200 group-hover:h-4"></span>
                    </a>
                </div>
                ...
                <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                    <article class="group bg-white rounded-md overflow-hidden shadow-sm hover:shadow-lg transition">
                        ...
                        <div class="p-5 flex flex-col gap-3">
                            <h3 class="text-lg font-semibold leading-snug text-gray-900 group-hover:text-green-700">
                                Como organizar suas finanças pessoais em 5 passos simples
                            </h3>

                            <p class="text-sm text-gray-600 line-clamp-3">
                                Organizar as finanças pessoais é essencial para alcançar estabilidade
                                financeira e tomar decisões mais conscientes.
                            </p>

                            <div class="mt-2 flex items-center gap-3 text-xs text-gray-500">
                                <img src="https://i.pravatar.cc/40?img=8" class="w-5 h-5 rounded-full" />
                                <span>Carlos Júnior</span>
                                <span>•</span>
                    ...
                    <article class="group bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition">
                        <div class="relative h-48">
                        ...
                        <div class="p-5 flex flex-col gap-3">
                            ...
                            <div class="flex items-center gap-3 text-xs text-gray-500">
                                <img src="https://i.pravatar.cc/40?img=12" class="w-5 h-5 rounded-full" />
                                <span>Carlos Júnior</span>
                                <span>•</span>
                                <span>7 min</span>
                            </div>
                    ...
                    <article class="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition">
                        ...
                        <div class="p-5 space-y-3">
                            ...
                            <div class="flex items-center gap-3 text-xs text-gray-500">
                                <img src="https://i.pravatar.cc/40?img=5" class="w-5 h-5 rounded-full">
                    ...
                    <article class="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition">
                        ...
                        <div class="p-5 space-y-3">
                            ...
                            <div class="flex items-center gap-3 text-xs text-gray-500">
                                <img src="https://i.pravatar.cc/40?img=45" class="w-5 h-5 rounded-full">
                                <span>Paulo Mendes</span>
                                <span>•</span>
                                <span>6 min</span>
                            </div>
                        </div>
