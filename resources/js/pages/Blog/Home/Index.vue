            ...
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="hidden md:flex items-center justify-center space-x-8 flex-1">
                    ...
                    <a href="#mais-lidos" class="relative inline-flex items-center text-sm font-medium text-[#1a202c] group">
                        ...
                        <span
                            class="absolute left-0 bottom-1 w-full h-1.5 bg-linear-to-r from-[#48bb78] to-[#38a169] opacity-80 transition-all duration-300 ease-out group-hover:h-4 group-hover:opacity-100 group-hover:from-[#38a169] group-hover:to-[#2f855a] animate-pulse shadow-sm group-hover:shadow-md group-hover:shadow-[#48bb78]/30"
                        ></span>
                    </a>
                </div>
